...
const EMAIL_LOGO = 'https://res.cloudinary.com/dgk3gaml0/image/upload/v1756224350/kuc37dmifsg42ojqxwc1.png';

function getEmailHeader() {
  return `
    <div style="background:#8a232c;padding:0 0 0 0;">
      <div style="padding:24px 0 0 0;text-align:center;">
        <img src="${EMAIL_LOGO}" width="180" height="60" style="margin-right:10px;object-fit:contain;" alt="Jiffy Lube Logo" />
      </div>
    </div>
    <div style="background:#fff;padding:0 0 0 0;">
      <div style="max-width:600px;margin:0 auto;padding:32px 24px 0 24px;font-family:Arial,sans-serif;">
  `;
}
...
function getEmailFooter() {
  return `
      ...
      <div style="text-align:center;margin:32px 0 0 0;">
        <img src="${EMAIL_LOGO}" width="120" height="40" style="object-fit:contain;" alt="Jiffy Lube Logo" />
      </div>
    </div>
  `;
}
